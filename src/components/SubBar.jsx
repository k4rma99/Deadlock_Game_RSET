...
let increment = 1;
    ...
    useEffect(() => {
        const f = () => {
            ...
            const light = document.querySelector(".sub-nav .tubelight");
	...
	<nav className="sub-nav">
		<ul>
			<li>
				<a className="active">
					<svg><use xlinkHref="#home-icon"></use></svg>
				</a>
			</li>
		</ul>
		<ul>
			<li>
				<a>
					<svg><use xlinkHref="#bookmark-icon"></use></svg>
				</a>
			</li>
		</ul>
		<ul>
			<li>
				<a>
					<svg><use xlinkHref="#plus-icon"></use></svg>
				</a>
			</li>
		</ul>
		<ul>
			<li>
				<a>
					<svg><use xlinkHref="#user-icon"></use></svg>
				</a>
			</li>
		</ul>
		<ul>
			<li>
				<a>
					<svg><use xlinkHref="#settings-icon"></use></svg>
				</a>
			</li>
